...
// Returns NOWHERE if a target location is not in the trail, otherwise returns
// corresponding DOUBLE_BACK ID
PlaceId in_trail(DraculaView dv, PlaceId target);

// Get shortest path between src and dest
...
bool is_sea(PlaceId src, PlaceId dest);
